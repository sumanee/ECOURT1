...
const BuffCase = {
  ...
  INSERT: ` INSERT INTO BUFF_CASE
    (CASEDTE, CASEDPTID, CASEMAINID, BLACKNO, REDNO, CASEDETAIL, CTEID, CTEDTE) 
    ...
    VALUES(CAST(@CASEDTE AS DATE) , @CASEDPTID, @CASEMAINID,@BLACKNO,@REDNO,@CASEDETAIL,@CTEID, GETDATE())`,
